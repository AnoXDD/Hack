...
void account::send(const std::string& to, const std::string& content, menu::maillist_vector *maillist) {
...
void account::receive(const std::string& from, const std::string& content, menu::maillist_vector* maillist) {
