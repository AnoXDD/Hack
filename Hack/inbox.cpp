...
void inbox::interact(menu* m, menu::maillist_vector* maillist) {
	// Add to maillist
...
menu* inbox::interact(const std::string& from, const std::string& content, menu::maillist_vector* maillist) {
